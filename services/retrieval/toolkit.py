...
def search_documents(
    ...
    return search_page_index(build_retrieval_index(documents), query, allowed_policies, top_k=top_k)
...
def citation_for_documents(
    ...
    results = search_documents(documents, query, allowed_policies, top_k=top_k)
    if not results:
