...
- Name: sidebar-navigation.spec.ts >> Sidebar Navigation Tests >> should navigate to Profiles page
- Location: e2e\sidebar-navigation.spec.ts:167:3
...
Call log:
  - waiting for locator('aside.nav a[href="/profiles"]')
