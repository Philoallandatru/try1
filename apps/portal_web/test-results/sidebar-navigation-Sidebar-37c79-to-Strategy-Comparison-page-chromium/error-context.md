...
- Name: sidebar-navigation.spec.ts >> Sidebar Navigation Tests >> should navigate to Strategy Comparison page
- Location: e2e\sidebar-navigation.spec.ts:154:3
...
Call log:
  - waiting for locator('aside.nav a[href="/strategy-comparison"]')
