...
- Name: sidebar-navigation.spec.ts >> Sidebar Navigation Tests >> should navigate to Chat page
- Location: e2e\sidebar-navigation.spec.ts:106:3
...
Call log:
  - waiting for locator('aside.nav a[href="/chat"]')
