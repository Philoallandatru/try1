...
- Name: analyze-real-backend.integration.spec.ts >> Analyze Page - Real Backend Integration >> should load workspace and profiles from backend
- Location: e2e\analyze-real-backend.integration.spec.ts:13:3
...
Locator: locator('label:has-text("Workspace") select')
Expected: visible
Timeout: 10000ms
