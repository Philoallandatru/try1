...
- Name: jira-confluence-full-flow.integration.spec.ts >> Jira/Confluence Full Integration Flow >> Step 2: Add Jira source with complete configuration
- Location: e2e\jira-confluence-full-flow.integration.spec.ts:82:3
