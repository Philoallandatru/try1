...
- Name: sidebar-navigation.spec.ts >> Sidebar Navigation Tests >> should navigate to Runs page
- Location: e2e\sidebar-navigation.spec.ts:179:3
...
Call log:
  - waiting for locator('aside.nav a[href="/runs"]')
