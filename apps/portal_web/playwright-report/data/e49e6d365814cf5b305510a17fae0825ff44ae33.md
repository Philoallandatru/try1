...
- Name: sidebar-navigation.spec.ts >> Sidebar Navigation Tests >> should maintain workspace selection across navigation
- Location: e2e\sidebar-navigation.spec.ts:245:3
...
Call log:
  - waiting for locator('select[data-testid="workspace-selector"]')
