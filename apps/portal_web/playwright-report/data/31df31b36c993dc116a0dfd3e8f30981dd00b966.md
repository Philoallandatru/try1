...
- Name: sidebar-navigation.spec.ts >> Sidebar Navigation Tests >> should navigate to Retrieval Debug page
- Location: e2e\sidebar-navigation.spec.ts:142:3
...
Call log:
  - waiting for locator('aside.nav a[href="/retrieval-debug"]')
